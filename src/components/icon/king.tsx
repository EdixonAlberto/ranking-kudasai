export function IconKing({ styles }: { styles: { [key: string]: string } }) {
  return (
    <svg className={styles.icon} xmlns="http://www.w3.org/2000/svg" width="576" height="512" viewBox="0 0 576 512">
      <path
        fill="currentColor"
